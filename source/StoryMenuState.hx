...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var sussyVarShower = new FlxText(50, 50, 0, "Var: "+ sussyWeekLocked, 50);
		sussyVarShower.setFormat("VCR OSD Mono", 32, FlxColor.WHITE, RIGHT);
		add(sussyVarShower);
		...
		leftArrow = new FlxSprite(FlxG.width * 0.66, grpWeekText.members[0].y + 10);
		...
		tracksSprite = new FlxSprite(0, bgSprite.y + 435).loadGraphic(Paths.image('Menu_Tracks'));

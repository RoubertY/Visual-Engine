...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['lag bruh', 0.2], //From 0% to 19%
		['keep upping up', 0.4], //From 20% to 39%
		['noob haha', 0.5], //From 40% to 49%
		['vine boom', 0.6], //From 50% to 59%
	...
	function goodNoteHit(note:Note):Void
	{
		if (!note.wasGoodHit)
		{
			...
			if(note.noteType == 2) {
				...
				// i am suffering, pls help i am making this at 12:00 am im going to sleep, just dont touch important code like camera move when bf singing or dad, and other list which im gonna make later

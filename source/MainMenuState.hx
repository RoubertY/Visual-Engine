...
class MainMenuState extends MusicBeatState
{
	...
	public static var visualEngineVersion:String = '1.0.0';
	...
	override function create()
	{
		...
		var bgDetail:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('mainmenuBGDetail'));
		bgDetail.scrollFactor.set(0, 0);
		bgDetail.updateHitbox();
		...
		for (i in 0...optionShit.length)
		{
			...
			var menuItem:FlxSprite = new FlxSprite(-1280, (i * 140)  + offset);
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Visual Engine v" + visualEngineVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
